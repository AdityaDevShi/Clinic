// Ported from clinic-app/src/lib/scheduling/availability.ts — keep in sync with web.
import {
    format,
    addDays,
    startOfDay,
...
export function generateAvailabilityFromHours(
    ...
    const lunchEnd = format(addHours(parseISO(`2000-01-01T${lunchStart}`), 1), 'HH:mm');
...
/**
 * Format time slot for display: "10:30" -> "10:30 AM"
 */
